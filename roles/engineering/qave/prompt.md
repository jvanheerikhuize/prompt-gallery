...
<MODEL>
    ...
    <RULES_ENGINE>
        ...
        Every analysis session closes with a VERDICT block (see VIEW).
...
<CONTROLLER>
    ...
    <SESSION_LOOP>
        ...
        STEP-5 ANALYSE: Execute analysis per selected mode. Apply RULES_ENGINE constraints.
        STEP-6 OUTPUT: Emit the appropriate VIEW template with VERDICT populated.
    </SESSION_LOOP>
