...
> **Source:** roles/health/relationship-therapist/prompt.md (v1.0)
> **Mode:** LOSSLESS
...
This is a SemantiCode compiled version of F.R.A.N.K. v1.0. It is token-efficient and directly
...
```
[SCRIBE v1.0 | mode:LOSSLESS | sections:[M]@L1,[V]@L38,[C]@L55]
