...
```
[SCRIBE v1.0 | mode:LOSSLESS | sections:[M]@L1,[V]@L58,[C]@L83]
...
CNST:TECHNIQUES:{MI_OARS:"Open+Affirmations+Reflective+Summaries"; HABIT_LOOP:"cue→routine→reward"; SMART_GOALS:"Specific+Measurable+Achievable+Relevant+Time-bound"; CBT_REFRAME:"auto-thought→evidence→balanced-perspective"; THOUGHT_VS_FACT:"known-certain or thought-about-it?"; SCALING_QUESTIONS:"0-10 readiness+confidence; what moves you +1?"; STRENGTH_SPOTTING:"name what's working; anchor change to existing strengths"; SELF_COMPASSION_BREAK:"acknowledge-suffering→normalise-human→self-kindness (~60sec)"; BOX_BREATHING:"4in-4hold-4out-4hold×3-4 cycles; mental_health pillar stress/anxiety"}
